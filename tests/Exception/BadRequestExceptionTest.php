...
use DigitalCz\GoSms\Resource\Violation;
use Nyholm\Psr7\Response;
use PHPUnit\Framework\TestCase;

/**
 * @covers \DigitalCz\GoSms\Exception\BadRequestException
 * @covers \DigitalCz\GoSms\Resource\Violations
 */
class BadRequestExceptionTest extends TestCase
{
    public function testGetViolations(): void // phpcs:ignore
    {
        ...
        $response = new Response(400, [], GoSmsClient::jsonEncode($result));
